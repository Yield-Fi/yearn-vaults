...
# def test_deposit(token, registry, vault, affiliate_token, gov, rando, vault_config, approver):
#     registry.newRelease(vault, {"from": gov})
#     registry.endorseVault(vault, {"from": gov})
...
#     vault_config.whitelist(affiliate_token, {"from": approver})
#     affiliate_token.deposit(10000, {"from": rando})
...
# def test_deposit_max_uint256(token, registry, vault, affiliate_token, gov, rando, vault_config, approver):
#     registry.newRelease(vault, {"from": gov})
#     registry.endorseVault(vault, {"from": gov})
#     token.transfer(rando, 10000, {"from": gov})
#     assert affiliate_token.balanceOf(rando) == vault.balanceOf(rando) == 0
...
# def test_migrate(token, registry, create_vault, affiliate_token, gov, rando, affiliate, vault_config, approver):
...
def test_transfer(token, registry, vault, affiliate_token, gov, rando, affiliate, vault_config, approver):
    registry.newRelease(vault, {"from": gov})
    registry.endorseVault(vault, {"from": gov})
    token.transfer(rando, 10000, {"from": gov})
    token.approve(affiliate_token, 10000, {"from": rando})
...
def test_withdraw(token, registry, vault, affiliate_token, gov, rando, vault_config, approver):
    registry.newRelease(vault, {"from": gov})
    registry.endorseVault(vault, {"from": gov})
    token.transfer(rando, 10000, {"from": gov})
    token.approve(affiliate_token, 10000, {"from": rando})
